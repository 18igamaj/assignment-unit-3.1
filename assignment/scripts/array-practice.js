...
// 1.a. TODO: Make an array with some favorite foods
 let favfoods= [ 'Shawarma', 'Steak', 'Chicken', 'Burritos' ];
...
console.log('List of Favorite foods:', favfoods.length  );
...
favfoods.push('Fries')
console.log('Added another food to end' , favfoods );
...
//     log both the food removed and the updated array
removedFood = favfoods.shift('Shrimp');
console.log(' Removed Shrimp from the top of my list' , removedFood);
console.log('All my favorite foods are now:' , favfoods);
